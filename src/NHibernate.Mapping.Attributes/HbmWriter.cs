...
if( element1 == null )
	...
	if( typeOfElement2 == typeof(PrimitiveArrayAttribute) )
				{
					if( element1 is JoinAttribute || element1 is SubclassAttribute || element1 is JoinedSubclassAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(JoinAttribute) )
				{
					if( element1 is SubclassAttribute || element1 is JoinedSubclassAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(SubclassAttribute) )
				{
					if( element1 is JoinedSubclassAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(JoinedSubclassAttribute) )
				{
					if( element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(UnionSubclassAttribute) )
				{
	...
	if( typeOfElement2 == typeof(KeyAttribute) )
				{
					if( element1 is PropertyAttribute || element1 is ManyToOneAttribute || element1 is ComponentAttribute || element1 is DynamicComponentAttribute || element1 is AnyAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(PropertyAttribute) )
				{
	...
	if( typeOfElement2 == typeof(MetaAttribute) )
				{
					if( element1 is JcsCacheAttribute || element1 is CacheAttribute || element1 is KeyAttribute || element1 is IndexAttribute || element1 is ListIndexAttribute || element1 is ElementAttribute || element1 is OneToManyAttribute || element1 is ManyToManyAttribute || element1 is CompositeElementAttribute || element1 is ManyToAnyAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(JcsCacheAttribute) )
				{
					if( element1 is CacheAttribute || element1 is KeyAttribute || element1 is IndexAttribute || element1 is ListIndexAttribute || element1 is ElementAttribute || element1 is OneToManyAttribute || element1 is ManyToManyAttribute || element1 is CompositeElementAttribute || element1 is ManyToAnyAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(CacheAttribute) )
				{
					if( element1 is KeyAttribute || element1 is IndexAttribute || element1 is ListIndexAttribute || element1 is ElementAttribute || element1 is OneToManyAttribute || element1 is ManyToManyAttribute || element1 is CompositeElementAttribute || element1 is ManyToAnyAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(KeyAttribute) )
				{
					if( element1 is IndexAttribute || element1 is ListIndexAttribute || element1 is ElementAttribute || element1 is OneToManyAttribute || element1 is ManyToManyAttribute || element1 is CompositeElementAttribute || element1 is ManyToAnyAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(IndexAttribute) )
				{
					if( element1 is ListIndexAttribute || element1 is ElementAttribute || element1 is OneToManyAttribute || element1 is ManyToManyAttribute || element1 is CompositeElementAttribute || element1 is ManyToAnyAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	...
	if( typeOfElement2 == typeof(ListAttribute) )
				{
					if( element1 is BagAttribute || element1 is IdBagAttribute || element1 is ArrayAttribute || element1 is PrimitiveArrayAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(BagAttribute) )
				{
					if( element1 is IdBagAttribute || element1 is ArrayAttribute || element1 is PrimitiveArrayAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(IdBagAttribute) )
				{
					if( element1 is ArrayAttribute || element1 is PrimitiveArrayAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(ArrayAttribute) )
				{
					if( element1 is PrimitiveArrayAttribute || element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(PrimitiveArrayAttribute) )
				{
					if( element1 is UnionSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(UnionSubclassAttribute) )
				{
...
writer.WriteStartElement( "union-subclass" );
			// Attribute: <name>
writer.WriteAttributeString("name", attribute.Name==null ? DefaultHelper.Get_UnionSubclass_Name_DefaultValue(type) : GetAttributeValue(attribute.Name, type));
			// Attribute: <proxy>
if(attribute.Proxy != null)
writer.WriteAttributeString("proxy", GetAttributeValue(attribute.Proxy, type));
			// Attribute: <lazy>
